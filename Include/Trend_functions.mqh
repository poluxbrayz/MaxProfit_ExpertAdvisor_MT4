...
string ValidateForce(string &Trend,int _MACD_TF,int Count_Periods,int ShiftM1,string _iSymbol){
   ...
   if(CurrentFunction=="CheckForOpen"){
      ...
      if(_MACD_TF<=TF_H1){
         ...
         MFITotal_TF=TF_D1; MFITotal_Periods=2; MFITotal_Up=41; MFITotal_Down=59; RSITotal_Up=46; RSITotal_Down=54;
         MFILastPeriod_TF=TF_H4; MFILastPeriod_Periods=6; MFILastPeriod_Up=55; MFILastPeriod_Down=45; RSILastPeriod_Up=60; RSILastPeriod_Down=40;//no modificar
      }
      else if(_MACD_TF<=TF_W1){ 
   ...
   if(CurrentFunction=="CheckForOpen"){
      //if(_MACD_TF<=TF_D1){
         ...
         double MFI3_H4=iMFI(_iSymbol,TF[TF_H4],4,3+Get_Shift(ShiftM1,TF[TF_H4]));
         double RSI1_H4=iRSI(_iSymbol,TF[TF_H4],4,PRICE_CLOSE,1+Get_Shift(ShiftM1,TF[TF_H4]));
         ...
         if(_MACD_TF==TF_D1){
            Print("ForceH4Trend=",ForceH4Trend,", MACD_Trend[TF__H4]=",MACD_Trend[TF_H4],", RSI_D1=",RSI_D1,", RSI1_D1=",RSI1_D1,", RSI1_D1_Close=",RSI1_D1_Close,", RSI_H4=",RSI_H4,", MFI_H4=",MFI_H4,", MFI1_H4=",MFI1_H4,", RSI1_H4=",RSI1_H4,", MFI2_H4=",MFI2_H4,", RSI2_H4=",RSI2_H4,", MFI_H1=",MFI_H1,", RSI_H1=",RSI_H1,", MFI_M30=",MFI_M30,", RSI_M30=",RSI_M30);
         }
...
bool IsConstantTrend(string Trend,int Max_Periods,int ShiftM1=0){
      ...
      for(_MACD_TF=TF_D1;_MACD_TF>=TF_H1;_MACD_TF--){   
         if(_MACD_TF==TF_D1){
            Max_Periods=(MACD_Trend[TF_D1]==W1Trend || ForceH4Trend==true)? 4 : ( ((MACD_Trend[TF_D1]==MACD_Trend[TF_W1]) || (MACD_Trend[TF_D1]!=MACD_Trend[TF_W1] && CountPeriodsTrend[TF_W1]==1))? 4 : 4);
