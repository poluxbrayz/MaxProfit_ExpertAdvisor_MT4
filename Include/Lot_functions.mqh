...
double TotalLot(){
   ...
   ForceLotUp=(MACD_Trend[TF_D1]=="Up" && MFIH4>=60 && MFI1H4>=54 && MFI2H4>=49 && RSIH4>=65 && MFIH1>=65 && MFI1H1>=60 && MFI2H1>=55 && RSIH1>=65 && SpreadD1>=AverageH1Spread*3.4 && SpreadH12>=AverageH1Spread*1.5 && SumSpread4Bars[TF_H4-TF_H1]>=AverageH1Spread*2 && SumSpread4Bars[TF_H1-TF_H1]>=AverageH1Spread*1);
   ForceLotDown=(MACD_Trend[TF_D1]=="Down" && MFIH4<=40 && MFI1H4<=46 && MFI2H4<=51 && RSIH4<=35 && MFIH1<=35 && MFI1H1<=40 && MFI2H1<=45 && RSIH1<=35 && SpreadD1<=-AverageH1Spread*3.4 && SpreadH12<=-AverageH1Spread*1.5 && SumSpread4Bars[TF_H4-TF_H1]<=-AverageH1Spread*2 && SumSpread4Bars[TF_H1-TF_H1]<=-AverageH1Spread*1);
