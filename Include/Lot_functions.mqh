...
double TotalLot(){
   ...
   double MFI2H1=iMFI(iSymbol,TF[TF_H1],5,2);
   ...
   ForceLotUp=(MACD_Trend[TF_D1]=="Up" && MFIH4>=64 && MFI1H4>=54 && MFI2H4>=49 && RSIH4>=67 && MFIH1>=67 && MFI1H1>=60 && MFI2H1>=55 && RSIH1>=67 && SpreadD1>=AverageH1Spread*3.5);
   ForceLotDown=(MACD_Trend[TF_D1]=="Down" && MFIH4<=36 && MFI1H4<=46 && MFI2H4<=51 && RSIH4<=33 && MFIH1<=33 && MFI1H1<=40 && MFI2H1<=45 && RSIH1<=33 && SpreadD1<=-AverageH1Spread*3.5);
